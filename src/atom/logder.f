...
c     *************************************************************************
c     COMPUTE LOGARITHMIC DERIVATIVES FOR POTENTIAL RV AT RADII NEAR RLOG,
c     FOR ENERGY E (NR RADII ARE CONSIDERED)--INTEGRATION SCHEME (LOG. GRID)
c     IS TAKEN FROM SCHEQ.  NNT1=FIRST DIM OF DL IN CALLING ROUTINE.
c     DLWF IS FOUND BY 4-PT INTERPOLATION OF P(Y) AND DPDY AT RLOG.
c     THIS VERSION PERMITS FINDING SECOND ENERGY DERIVATIVES IN TERMS OF
c     RELATED CORE CHARGE FOR WF.--GRID OF 5 ENERGIES, SPACING DE--THIS
c     CALC. DONE WHEN IDER.NE.0.   FOR USE IN OBTAINING EXTENDED NC PSP.
c     *************************************************************************
...
c     -------------------------------------------------------------------------
      ...
      dimension rv(npdm),r(npdm),dl(nnt1,npdm),p(npdm),dld(npdm),g(npdm)
